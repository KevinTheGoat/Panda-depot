...
export default function CatalogSearch({ allProducts, categories }) {
            ...
            {filtered.map((product) => (
              ...
              >
                <div className="flex items-start justify-between gap-2">
                  ...
                  <a href="/contact" className="text-panda-red text-xs font-medium whitespace-nowrap hover:underline">
                    Call to inquire
                  </a>
                </div>
                ...
                <a
                  href={`/catalog/${slugify(product.category)}`}
